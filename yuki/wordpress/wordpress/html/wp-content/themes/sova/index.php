               ...
               <div class="slick_container">
                 ...
                 <ul class="pick_column_slide">
                   <li class="pick_column_slide_item">
                     <a href="column_detail.html" class="pick_column_slide_img box_img" style="background-image:url(static/images/sample/sample_slide01.jpg);">
                     </a>
                   ...
                   <li class="pick_column_slide_item">
                     <a href="column_detail.html" class="pick_column_slide_img box_img" style="background-image:url(static/images/sample/sample_slide02.jpg">
                     </a>
                     <div class="pick_column_slide_category_date">
                       <a href="column_list.html" class="pick_column_slide_category">
                         <p>よくある質問</p>
                   ...
                   <li class="pick_column_slide_item">
                     <a href="column_detail.html" class="pick_column_slide_img box_img" style="background-image:url(static/images/sample/sample_slide03.jpg">
                     </a>
                     <div class="pick_column_slide_category_date">
                       <a href="column_list.html" class="pick_column_slide_category">
                         <p>よくある質問</p>
               ...
               <section class="top_comic">
                 ...
                 <div class="comic_box_wrap">
                   <div class="comic_box">
                     ...
                     <a href="comic_detail.html" class="comic_box_img box_img" style="background-image:url(static/images/sample/sample03.png);"></a>
                   ...
                   <div class="comic_box">
                     ...
                     <a href="comic_detail.html" class="comic_box_img box_img" style="background-image:url(static/images/sample/sample04.png);"></a>
                     <div class="comic_box_category_date">
                       <a href="comic_list.html" class="comic_box_category">
                         <p>グルメ</p>
                       </a>
                   ...
                   <div class="comic_box">
                     ...
                     <a href="comic_detail.html" class="comic_box_img box_img" style="background-image:url(static/images/sample/sample05.png);"></a>
                     <div class="comic_box_category_date">
                       <a href="comic_list.html" class="comic_box_category">
                         <p>グルメ</p>
                       </a>
                   ...
                   <div class="comic_box">
                     ...
                     <a href="comic_detail.html" class="comic_box_img box_img" style="background-image:url(static/images/sample/sample06.png);"></a>
                     <div class="comic_box_category_date">
                       <a href="comic_list.html" class="comic_box_category">
                         <p>グルメ</p>
                       </a>
               ...
               <section class="top_online_store">
                 ...
                 <div class="store_item_box_wrap">
                   <a href="shop/item_detail.html" class="store_item_box">
                     <div class="store_item_box_img" style="background-image:url(static/images/sample/sample07.png);">
                     </div>
                   ...
                   <a href="shop/item_detail.html" class="store_item_box">
                     <div class="store_item_box_img" style="background-image:url(static/images/sample/sample08.png);">
                     </div>
                     <h3 class="store_item_box_title">
                       お寿司Tシャツ
                     </h3>
                   ...
                   <a href="shop/item_detail.html" class="store_item_box">
                     <div class="store_item_box_img" style="background-image:url(static/images/sample/sample09.png);">
                     </div>
                     <h3 class="store_item_box_title">
                       みちづれTシャツ
                     </h3>
