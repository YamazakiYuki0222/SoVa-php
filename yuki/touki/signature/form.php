...
<body>
  <form action="index.php" method="post">
    ...
    <p><label>Q3.代表取締役のお名前</label><input type="text" name="president_name" value="<?=$company_information['president_name'] ?>" placeholder="蕎麦一郎"></p>
    <p><label>Q4.代表取締役の住所</label><input type="text" name="president_address" value="<?=$company_information['president_address']?>"placeholder="東京都千代田区麹町9-99-9"></p>
    <p><label>Q5.代表取締役の生年月日</label><input type="date" name="birthday_president"></p>
    <h3>新しい会社名を教えてください</h3>
    <p><label>Q6.会社名</label><input type="text" name="new_name" placeholder="株式会社NEW Sample">
    <h3>会社名を変更した日付を教えてください</h3>
    <p><label>Q7.変更日</label><input type="date" name="date"></p>
